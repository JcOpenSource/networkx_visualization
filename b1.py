...
plt.scatter(x, y2, alpha=0.8, c="k")
plt.scatter(x_degree, y_count, alpha=0.8, c="silver")
xlabel_obj = plt.xlabel('degree', fontsize=14, alpha=0.5)
ylabel_obj = plt.ylabel('y_count', fontsize=14, alpha=0.5)
